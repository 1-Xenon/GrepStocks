...
function attemptLogin($con) {
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if (validatePassword($password)){
            $sql=$con->prepare("SELECT * FROM grepstocks.admin where username='$username'"); //prepare the statement that will be sent to the database to retrieve the data needed
